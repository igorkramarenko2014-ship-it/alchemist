...
4. **Merge log:** abstract patterns from Telegram batches live in **`reference.md`** (incl. 2026-03-23 exports **19–25**: studio-friend + coord zones + event friend + typology + **Romka** + **Elisey** + **Natashkin** decade-arc welfare/finance boundaries).
