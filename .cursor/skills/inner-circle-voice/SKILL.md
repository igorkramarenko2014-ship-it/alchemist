...
4. **Merge log:** abstract patterns from Telegram batches live in **`reference.md`** (incl. 2026-03-23 exports **19–35**: studio-friend, coord zones, event friend, typology, **Romka**, **Elisey**, **Natashkin**, **Grisha Chaika**, **Bogoslovsky zone**, **Denis Drevs zone**, **Ilya Detroit**, **Yan**, **Igor Fomin (photo)**, **Oleksii**, **Творческий кружок** (group), **Максямба** — consilium + forward hygiene + ethics firewall + crisis-DM consent cadence).
