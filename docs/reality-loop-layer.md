...
**Privacy / security:** Payloads use **hashes and enums** — no raw prompts in telemetry (`telemetry-redact.ts` still applies). Retention and lawful basis belong in `PRIVACY.md` before wide deployment.
