...
- Last verification timestamp from canonical truth artifact: `2026-04-02T22:04:51.920Z`
- Metrics sync timestamp from canonical truth artifact: `2026-04-02T22:04:51.884Z`
- Truth file hash: `0dd274f68c33e736ad79f90af1480b20655022613b08769e2654eb50fcea3673`
...
|--------|-------|----------|------------|--------|-------------------|
| Tests passed | 481 / 481 | `metrics.testsPassed == metrics.testsTotal` | Total passing tests in latest shared-engine Vitest run | `artifacts/truth-matrix.json` (`metrics.testsPassed`, `metrics.testsTotal`) | `jq '.metrics | { testsPassed, testsTotal }' artifacts/truth-matrix.json` |
...
| Sync timestamp (UTC) | 2026-04-02T22:04:51.884Z | ISO 8601 timestamp | Time written by truth aggregation script | `artifacts/truth-matrix.json` (`metrics.syncedAtUtc`) | `jq '.metrics.syncedAtUtc' artifacts/truth-matrix.json` |
