...
- Last verification timestamp from canonical truth artifact: `2026-03-31T09:16:37.456Z`
- Metrics sync timestamp from canonical truth artifact: `2026-03-31T09:16:37.429Z`
- Truth file hash: `911f27d410b64953ba33e21aba1c09022527f0b43a73af231035d93a9db37b22`
...
|--------|-------|----------|------------|--------|-------------------|
| Tests passed | 393 / 393 | `metrics.testsPassed == metrics.testsTotal` | Total passing tests in latest shared-engine Vitest run | `artifacts/truth-matrix.json` (`metrics.testsPassed`, `metrics.testsTotal`) | `jq '.metrics | { testsPassed, testsTotal }' artifacts/truth-matrix.json` |
...
| Sync timestamp (UTC) | 2026-03-31T09:16:37.429Z | ISO 8601 timestamp | Time written by truth aggregation script | `artifacts/truth-matrix.json` (`metrics.syncedAtUtc`) | `jq '.metrics.syncedAtUtc' artifacts/truth-matrix.json` |
